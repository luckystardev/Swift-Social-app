...
class SettingsSecurityViewController: UIViewController , UITableViewDelegate, UITableViewDataSource {
    ...
    */
    ...
    @IBAction func m_switchForPhoneDiscoverability(sender: AnyObject) {
    }
    @IBAction func m_switchForEmailDiscoverability(sender: AnyObject) {
    }
    @IBAction func m_switchForOnlyMyFriends(sender: AnyObject) {
    }
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        let arrCellIdentifiers = ["SettingsGeneralCellId1", "SettingsGeneralCellId2", "SettingsGeneralCellId3", "SettingsGeneralCellId4"]
