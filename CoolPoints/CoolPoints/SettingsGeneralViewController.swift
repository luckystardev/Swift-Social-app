...
class SettingsGeneralViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    */
    ...
    @IBAction func m_imageSwitchChanged(sender: AnyObject) {
    }
    @IBAction func m_soundSwitchChanged(sender: AnyObject) {
    }
